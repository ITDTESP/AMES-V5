...
public class SelectPanel extends javax.swing.JPanel {
    ...
    public SelectPanel(AMESFrame frame,boolean ifTableView, TableView view, SplitChart pFrame) {
        ...
        outputDataTypeSelect="GenCo Schedules (Benchmark)";
        ...
        if(ifDisplayTable){
            ...
            outputDataTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "GenCo Schedules (Benchmark)", "GenCo Profits & Net Earnings (Benchmark)", "LSE Price-Sensitive Demand (Benchmark)", "LSE Price-Sens. Net Earnings (Benchmark)", "LMPs (Benchmark)", "GenCo Reported Supply Offers", "GenCo Schedules", "GenCo Profits and Net Earnings", "LSE Price-Sensitive Net Earnings", "LSE Price-Sensitive Demand", "Branch Power Flows", "LMPs" }));
    ...
    private void outputDisplayButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_outputDisplayButtonActionPerformed
        ...
        if(ifDisplayTable) {
            if(outputDataTypeSelect.equalsIgnoreCase("GenCo Schedules (Benchmark)")) {
            ...
            else  if(outputDataTypeSelect.equalsIgnoreCase("GenCo Schedules")) {
            ...
            if(outputDataTypeSelect.equalsIgnoreCase("GenCo Schedules (Benchmark)")) {
                ...
                parentFrame.drawNodeRealTimeLMPData(outputTimeTypeSelect, iStartTime, iEndTime, iDayHour, selectIndex);
            }
        }
    ...
    public String VerifyEndTime(){
        ...
        try {
            ...
            if(iTemp<iStartTime){
             ...
             outputDataTypeSelect.equalsIgnoreCase("GenCo Schedules")||
             outputDataTypeSelect.equalsIgnoreCase("RealTimeLMPs")){
   ...
   public void updateOutputDataNameList( ) {
        ...
        else if((outputDataTypeSelect.equalsIgnoreCase("GenCo Schedules (Benchmark)"))
        ...
        ||(outputDataTypeSelect.equalsIgnoreCase("Total Reported Supply & Demand"))){
            ...
            if(outputDataTypeSelect.equalsIgnoreCase("GenCo Schedules"))
                maxTimeDisplay.setText("From Day 2 to Day "+String.valueOf(iMaxTime+1));
