                ...
                if (!SolutionStatus.equals("infeasible")) {
                    ...
                    if (stopCode > 0) {
                        ...
                        System.out.println("\nThe current simulation run is concluded for " + day + " days\n"); // + " in response to the activation of the following \nstopping rule:(" + stopStr + ")\n\n");
                            int size = RTLMP.length;
                            System.out.println("Size of the double array: " + size);
                    }
                    if(day==1){       
                        count = count + 5;
                    }
...
//       System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBTT");
//       System.out.println("RTLMP Valus");
//       System.out.print( "HrlyIntrvl  ");
//       for (int j = 0; j < iCol; j++) {
//                System.out.print( "Bus"+(j+1)+"  ");
//       }
//        System.out.println("");
//        for (int i = 0; i < iRow; i++) {
//            System.out.print( (i+1) +"      ");
//            for (int j = 0; j < iCol; j++) {
//                System.out.print( (1000*object[i][j])/1000.0 + "    ");
//            }
//            System.out.println("");
//        }
//       
