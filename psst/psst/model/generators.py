...
def initialize_generators(model,
    ...
    # click.echo("///////////////genatbus/////////////////////")
    # model.GeneratorsAtBus.pprint()
    # click.echo()

# added function  akash 
# def gen_atBus(model, atBus = None):
#     model.GenatBus = Param(initialize = atBus )
...
def maximum_reserve_limits(model, r_limits = None):
    model.Rmax = Param(model.Generators, initialize = r_limits, within = NonNegativeReals)
    model.Rmax.pprint()
